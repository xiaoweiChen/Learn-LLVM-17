...
\begin{document}
  \begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
    ...
    \mySubsection{3.2.}{创建项目布局}{content/part2/chapter3/2.tex}
    ...
    \mySubsection{6.3.}{添加调试元数据}{content/part2/chapter6/3.tex}
    ...
    \mySubsection{10.2.}{用消毒程序检测应用程序}{content/part3/chapter10/2.tex}
    ...
    \mySubsection{11.1.}{为新后端搭建舞台}{content/part4/chapter11/1.tex}
    ...
    \mySubsection{12.4.}{将空框架降低到位}{content/part4/chapter12/4.tex}
